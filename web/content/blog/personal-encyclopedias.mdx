...
date: "2026-03-25T18:00:00-07:00"
---
...
<ThemedImage light="/blog/01-light.webp" dark="/blog/01-dark.webp"/>
...
<ThemedImage light="/blog/02-light.webp" dark="/blog/02-dark.webp"/>
...
<ThemedImage light="/blog/03-light.webp" dark="/blog/03-light.webp"/>
...
<SideBySide>
<ThemedImage light="/blog/04a-light.webp" dark="/blog/04a-light.webp"/>
<ThemedImage light="/blog/04b-light.webp" dark="/blog/04b-light.webp"/>
</SideBySide>
...
<WideImage light="/blog/05-light.webp" dark="/blog/05-light.webp"/>
...
<ThemedImage light="/blog/06-light.webp" dark="/blog/06-dark.webp"/>
...
<WideImage light="/blog/07-light.webp" dark="/blog/07-light.webp"/>
...
<ThemedImage light="/blog/08-light.webp" dark="/blog/08-dark.webp"/>
...
1. In a follow-up, I mentioned remembering an evening dinner with a guitarist playing in the background. It filtered my media to evening captures, found a frame in a video with the guitarist, uploaded it, and referenced the moment in the page.
...
<WideImage light="/blog/09-light.webp" dark="/blog/09-light.webp"/>
...
<WideImage light="/blog/10-light.webp" dark="/blog/10-light.webp"/>
...
I built this originally as whoami.wiki — a personal encyclopedia. It uses MediaWiki as its foundation, which turns out to be a great fit because language models already understand Wikipedia conventions deeply from their training data. You bring your data, and agents draft the pages for you to review.
...
Since then, the project has evolved into [ProjectWiki](/) — a construction project management wiki. The same principles that made personal encyclopedias work (structured pages, cross-references, agent-driven analysis, traceability) turned out to be a powerful fit for construction contract documents. Agents analyze drawings, extract specification requirements, process RFIs, and build an interconnected knowledge base for the entire project. A page about a clarifier basin works the same way as a page about a historical landmark — the Wikipedia conventions carry over naturally.

Today ProjectWiki is an open source project. It runs on your machine, your documents stay with you, and any model can read it. If this sounds interesting, you can [get started here](/docs/installation) and tell me what you think!
