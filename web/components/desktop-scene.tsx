      ...
      },
      {
        ...
        page: {
          ...
          sections: [
            ...
            { heading: "Daily life", body: "Mornings started slow — Priya made pour-over coffee on the balcony while everyone else surfaced. Meera read a Murakami novel in the hammock for three straight days. Plans materialized around noon. Afternoons at Anjuna Beach or exploring Panjim — Rohit insisted on visiting the Basilica of Bom Jesus, which nobody else cared about but everyone agreed was worth it. Evenings revolved around finding a restaurant; a place called Gunpowder near Assagao became the default after night three. [[Sid]] kept a running list of sunset times and insisted on catching every one from the balcony.", images: ["img_goa_beach", "img_goa_sunset"] },
    ...
    items: [
      ...
      },
      {
        ...
        page: {
          ...
          scrollTop: 40,
          sections: [
            { heading: "The plan", body: "Summer 2014. Jay, [[Sid]], and two school friends — Ankit and Devesh, both of whom Jay has since lost touch with — wanted a PS3 controller but nobody had ₹2,500. The plan was simple: one person distracts the staff, one grabs the controller, two act as lookouts. They spent three days planning over Frooti boxes in Sid's room while his parents were at work. The plan was written on the back of a Croma flyer. In retrospect, it had no exit strategy and relied on the assumption that Croma had no security cameras (it did).", images: ["img_croma_store"] },
    ...
    items: [
      {
        ...
        page: {
          ...
          scrollTop: 60,
          sections: [
            { heading: "The startup folds", body: "Jay had been at Brevity, a SaaS startup building invoicing tools for freelancers, for eighteen months when COVID hit. They were six people in a WeWork in Koramangala. By April 10, 2020, the Series A fell through, the Slack went quiet, and Jay found out via a two-paragraph email from the founder. The fintech job at PayGrid came through a BITS alumni referral — a senior engineer named Tanvi who'd been two years above Jay — three weeks later. He started remotely from his childhood bedroom in Pune, debugging payment APIs while Kavya attended online lectures in the next room.", images: ["img_lockdown_desk"] },
...
const standalonePages: WindowItem[] = [
  ...
  },
  {
    ...
    page: {
      ...
      scrollTop: 0,
      sections: [
        { heading: "The younger sister", body: "Four years younger than Jay. Grew up watching him collect [[Hot Wheels Collection|Hot Wheels]], fail to learn guitar, leave for BITS, and somehow turn into an adult with an apartment and a job. By the time she was in high school, Jay was already a voice on the phone who sent money on Paytm for her birthday. The sibling relationship is conducted almost entirely through Instagram reels, the Prakash Family WhatsApp group (four members, 80% [[Aai]]'s forwards), and Kavya's role as unofficial relay between Jay and their parents." },
        ...
        { heading: "The Hot Wheels birthday", body: "For Jay's 24th birthday, Kavya bought him a Hot Wheels car from a toy store in Pilani. She didn't know the model, the series, or what a Treasure Hunt was — she picked it because it was blue and Jay likes blue. The spreadsheet entry reads: \"birthday gift from Kavya, she doesn't know what a Treasure Hunt is but she tried.\" It's in the display case.", quote: "Birthday gift from Kavya. She doesn't know what a Treasure Hunt is but she tried.", quoteAttrib: "— Hot Wheels spreadsheet" },
  ...
  },
  {
    ...
    page: {
      ...
      infobox: [{ label: "Relation", value: "Father" }, { label: "Location", value: "Pune" }, { label: "Born", value: "Satara" }, { label: "Education", value: "B.Com, Garware College" }, { label: "Occupation", value: "Retired bank officer" }, { label: "Gave Jay", value: "The Canon PowerShot" }],
